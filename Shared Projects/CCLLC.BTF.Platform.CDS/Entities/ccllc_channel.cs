namespace CCLLC.BTF.Platform.CDS
{
	...
	public partial class ccllc_channel : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public System.Nullable<CCLLC.BTF.Platform.CDS.ccllc_channeltypeoptions> ccllc_ChannelTypeCode
		{
			get
			{
				...
				if ((optionSet != null))
				{
					return ((CCLLC.BTF.Platform.CDS.ccllc_channeltypeoptions)(System.Enum.ToObject(typeof(CCLLC.BTF.Platform.CDS.ccllc_channeltypeoptions), optionSet.Value)));
				}
				else
				{
					return null;
		...
		public System.Nullable<CCLLC.BTF.Platform.CDS.ccllc_customerinteractionscopeoptions> ccllc_CustomerInteractionScopeCode
		{
			get
			{
				...
				if ((optionSet != null))
				{
					return ((CCLLC.BTF.Platform.CDS.ccllc_customerinteractionscopeoptions)(System.Enum.ToObject(typeof(CCLLC.BTF.Platform.CDS.ccllc_customerinteractionscopeoptions), optionSet.Value)));
				}
				else
				{
					return null;
		...
		public System.Nullable<CCLLC.BTF.Platform.CDS.ccllc_channelState> statecode
		{
			get
			{
				...
				if ((optionSet != null))
				{
					return ((CCLLC.BTF.Platform.CDS.ccllc_channelState)(System.Enum.ToObject(typeof(CCLLC.BTF.Platform.CDS.ccllc_channelState), optionSet.Value)));
				}
				else
				{
					return null;
		...
		public System.Nullable<CCLLC.BTF.Platform.CDS.ccllc_channel_statuscode> statuscode
		{
			get
			{
				...
				if ((optionSet != null))
				{
					return ((CCLLC.BTF.Platform.CDS.ccllc_channel_statuscode)(System.Enum.ToObject(typeof(CCLLC.BTF.Platform.CDS.ccllc_channel_statuscode), optionSet.Value)));
				}
				else
				{
					return null;
		...
		public CCLLC.BTF.Platform.CDS.BusinessUnit business_unit_ccllc_channel
		{
			get
			{
				return this.GetRelatedEntity<CCLLC.BTF.Platform.CDS.BusinessUnit>("business_unit_ccllc_channel", null);
			}
		}
		...
		public CCLLC.BTF.Platform.CDS.SystemUser lk_ccllc_channel_createdby
		{
			get
			{
				return this.GetRelatedEntity<CCLLC.BTF.Platform.CDS.SystemUser>("lk_ccllc_channel_createdby", null);
			}
		}
		...
		public CCLLC.BTF.Platform.CDS.SystemUser lk_ccllc_channel_createdonbehalfby
		{
			get
			{
				return this.GetRelatedEntity<CCLLC.BTF.Platform.CDS.SystemUser>("lk_ccllc_channel_createdonbehalfby", null);
			}
		}
		...
		public CCLLC.BTF.Platform.CDS.SystemUser lk_ccllc_channel_modifiedby
		{
			get
			{
				return this.GetRelatedEntity<CCLLC.BTF.Platform.CDS.SystemUser>("lk_ccllc_channel_modifiedby", null);
			}
		}
		...
		public CCLLC.BTF.Platform.CDS.SystemUser lk_ccllc_channel_modifiedonbehalfby
		{
			get
			{
				return this.GetRelatedEntity<CCLLC.BTF.Platform.CDS.SystemUser>("lk_ccllc_channel_modifiedonbehalfby", null);
			}
		}
		...
		public CCLLC.BTF.Platform.CDS.ccllc_partner ccllc_partner_channel
		{
			get
			{
				return this.GetRelatedEntity<CCLLC.BTF.Platform.CDS.ccllc_partner>("ccllc_partner_channel", null);
			}
			set
			{
				this.OnPropertyChanging("ccllc_partner_channel");
				this.SetRelatedEntity<CCLLC.BTF.Platform.CDS.ccllc_partner>("ccllc_partner_channel", null, value);
		...
		public CCLLC.BTF.Platform.CDS.SystemUser user_ccllc_channel
		{
			get
			{
				return this.GetRelatedEntity<CCLLC.BTF.Platform.CDS.SystemUser>("user_ccllc_channel", null);
			}
		}
	}
}
