namespace CCLLC.BTF.Platform.CDS
{
	...
	public partial class CustomerAddress : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public System.Nullable<CCLLC.BTF.Platform.CDS.customeraddress_addresstypecode> AddressTypeCode
		{
			get
			{
				...
				if ((optionSet != null))
				{
					return ((CCLLC.BTF.Platform.CDS.customeraddress_addresstypecode)(System.Enum.ToObject(typeof(CCLLC.BTF.Platform.CDS.customeraddress_addresstypecode), optionSet.Value)));
				}
				else
				{
					return null;
		...
		public System.Nullable<CCLLC.BTF.Platform.CDS.customeraddress_freighttermscode> FreightTermsCode
		{
			get
			{
				...
				if ((optionSet != null))
				{
					return ((CCLLC.BTF.Platform.CDS.customeraddress_freighttermscode)(System.Enum.ToObject(typeof(CCLLC.BTF.Platform.CDS.customeraddress_freighttermscode), optionSet.Value)));
				}
				else
				{
					return null;
		...
		public System.Nullable<CCLLC.BTF.Platform.CDS.customeraddress_shippingmethodcode> ShippingMethodCode
		{
			get
			{
				...
				if ((optionSet != null))
				{
					return ((CCLLC.BTF.Platform.CDS.customeraddress_shippingmethodcode)(System.Enum.ToObject(typeof(CCLLC.BTF.Platform.CDS.customeraddress_shippingmethodcode), optionSet.Value)));
				}
				else
				{
					return null;
		...
		public CCLLC.BTF.Platform.CDS.Account Account_CustomerAddress
		{
			get
			{
				return this.GetRelatedEntity<CCLLC.BTF.Platform.CDS.Account>("Account_CustomerAddress", null);
			}
			set
			{
				this.OnPropertyChanging("Account_CustomerAddress");
				this.SetRelatedEntity<CCLLC.BTF.Platform.CDS.Account>("Account_CustomerAddress", null, value);
		...
		public CCLLC.BTF.Platform.CDS.Contact Contact_CustomerAddress
		{
			get
			{
				return this.GetRelatedEntity<CCLLC.BTF.Platform.CDS.Contact>("Contact_CustomerAddress", null);
			}
			set
			{
				this.OnPropertyChanging("Contact_CustomerAddress");
				this.SetRelatedEntity<CCLLC.BTF.Platform.CDS.Contact>("Contact_CustomerAddress", null, value);
		...
		public CCLLC.BTF.Platform.CDS.SystemUser lk_customeraddress_createdonbehalfby
		{
			get
			{
				return this.GetRelatedEntity<CCLLC.BTF.Platform.CDS.SystemUser>("lk_customeraddress_createdonbehalfby", null);
			}
		}
		...
		public CCLLC.BTF.Platform.CDS.SystemUser lk_customeraddress_modifiedonbehalfby
		{
			get
			{
				return this.GetRelatedEntity<CCLLC.BTF.Platform.CDS.SystemUser>("lk_customeraddress_modifiedonbehalfby", null);
			}
		}
		...
		public CCLLC.BTF.Platform.CDS.SystemUser lk_customeraddressbase_createdby
		{
			get
			{
				return this.GetRelatedEntity<CCLLC.BTF.Platform.CDS.SystemUser>("lk_customeraddressbase_createdby", null);
			}
		}
		...
		public CCLLC.BTF.Platform.CDS.SystemUser lk_customeraddressbase_modifiedby
		{
			get
			{
				return this.GetRelatedEntity<CCLLC.BTF.Platform.CDS.SystemUser>("lk_customeraddressbase_modifiedby", null);
			}
		}
	}
}
