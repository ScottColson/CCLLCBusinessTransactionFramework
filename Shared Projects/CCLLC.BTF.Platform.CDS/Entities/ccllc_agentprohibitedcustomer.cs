namespace CCLLC.BTF.Platform.CDS
{
	...
	public partial class ccllc_agentprohibitedcustomer : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public System.Nullable<CCLLC.BTF.Platform.CDS.ccllc_agentprohibitedcustomerState> statecode
		{
			get
			{
				...
				if ((optionSet != null))
				{
					return ((CCLLC.BTF.Platform.CDS.ccllc_agentprohibitedcustomerState)(System.Enum.ToObject(typeof(CCLLC.BTF.Platform.CDS.ccllc_agentprohibitedcustomerState), optionSet.Value)));
				}
				else
				{
					return null;
		...
		public System.Nullable<CCLLC.BTF.Platform.CDS.ccllc_agentprohibitedcustomer_statuscode> statuscode
		{
			get
			{
				...
				if ((optionSet != null))
				{
					return ((CCLLC.BTF.Platform.CDS.ccllc_agentprohibitedcustomer_statuscode)(System.Enum.ToObject(typeof(CCLLC.BTF.Platform.CDS.ccllc_agentprohibitedcustomer_statuscode), optionSet.Value)));
				}
				else
				{
					return null;
		...
		public CCLLC.BTF.Platform.CDS.BusinessUnit business_unit_ccllc_agentprohibitedcustomer
		{
			get
			{
				return this.GetRelatedEntity<CCLLC.BTF.Platform.CDS.BusinessUnit>("business_unit_ccllc_agentprohibitedcustomer", null);
			}
		}
		...
		public CCLLC.BTF.Platform.CDS.SystemUser lk_ccllc_agentprohibitedcustomer_createdby
		{
			get
			{
				return this.GetRelatedEntity<CCLLC.BTF.Platform.CDS.SystemUser>("lk_ccllc_agentprohibitedcustomer_createdby", null);
			}
		}
		...
		public CCLLC.BTF.Platform.CDS.SystemUser lk_ccllc_agentprohibitedcustomer_createdonbehalfby
		{
			get
			{
				return this.GetRelatedEntity<CCLLC.BTF.Platform.CDS.SystemUser>("lk_ccllc_agentprohibitedcustomer_createdonbehalfby", null);
			}
		}
		...
		public CCLLC.BTF.Platform.CDS.SystemUser lk_ccllc_agentprohibitedcustomer_modifiedby
		{
			get
			{
				return this.GetRelatedEntity<CCLLC.BTF.Platform.CDS.SystemUser>("lk_ccllc_agentprohibitedcustomer_modifiedby", null);
			}
		}
		...
		public CCLLC.BTF.Platform.CDS.SystemUser lk_ccllc_agentprohibitedcustomer_modifiedonbehalfby
		{
			get
			{
				return this.GetRelatedEntity<CCLLC.BTF.Platform.CDS.SystemUser>("lk_ccllc_agentprohibitedcustomer_modifiedonbehalfby", null);
			}
		}
		...
		public CCLLC.BTF.Platform.CDS.Account ccllc_account_prohibitedagent
		{
			get
			{
				return this.GetRelatedEntity<CCLLC.BTF.Platform.CDS.Account>("ccllc_account_prohibitedagent", null);
			}
			set
			{
				this.OnPropertyChanging("ccllc_account_prohibitedagent");
				this.SetRelatedEntity<CCLLC.BTF.Platform.CDS.Account>("ccllc_account_prohibitedagent", null, value);
		...
		public CCLLC.BTF.Platform.CDS.ccllc_agent ccllc_agent_prohibitedcustomer
		{
			get
			{
				return this.GetRelatedEntity<CCLLC.BTF.Platform.CDS.ccllc_agent>("ccllc_agent_prohibitedcustomer", null);
			}
			set
			{
				this.OnPropertyChanging("ccllc_agent_prohibitedcustomer");
				this.SetRelatedEntity<CCLLC.BTF.Platform.CDS.ccllc_agent>("ccllc_agent_prohibitedcustomer", null, value);
		...
		public CCLLC.BTF.Platform.CDS.Contact ccllc_contact_prohibitedagent
		{
			get
			{
				return this.GetRelatedEntity<CCLLC.BTF.Platform.CDS.Contact>("ccllc_contact_prohibitedagent", null);
			}
			set
			{
				this.OnPropertyChanging("ccllc_contact_prohibitedagent");
				this.SetRelatedEntity<CCLLC.BTF.Platform.CDS.Contact>("ccllc_contact_prohibitedagent", null, value);
		...
		public CCLLC.BTF.Platform.CDS.SystemUser user_ccllc_agentprohibitedcustomer
		{
			get
			{
				return this.GetRelatedEntity<CCLLC.BTF.Platform.CDS.SystemUser>("user_ccllc_agentprohibitedcustomer", null);
			}
		}
	}
}
