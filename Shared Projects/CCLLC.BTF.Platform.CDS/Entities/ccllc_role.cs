namespace CCLLC.BTF.Platform.CDS
{
	...
	public partial class ccllc_role : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public System.Nullable<CCLLC.BTF.Platform.CDS.ccllc_roleState> statecode
		{
			get
			{
				...
				if ((optionSet != null))
				{
					return ((CCLLC.BTF.Platform.CDS.ccllc_roleState)(System.Enum.ToObject(typeof(CCLLC.BTF.Platform.CDS.ccllc_roleState), optionSet.Value)));
				}
				else
				{
					return null;
		...
		public System.Nullable<CCLLC.BTF.Platform.CDS.ccllc_role_statuscode> statuscode
		{
			get
			{
				...
				if ((optionSet != null))
				{
					return ((CCLLC.BTF.Platform.CDS.ccllc_role_statuscode)(System.Enum.ToObject(typeof(CCLLC.BTF.Platform.CDS.ccllc_role_statuscode), optionSet.Value)));
				}
				else
				{
					return null;
		...
		public System.Collections.Generic.IEnumerable<CCLLC.BTF.Platform.CDS.ccllc_agentrole> ccllc_role_agentrole
		{
			get
			{
				return this.GetRelatedEntities<CCLLC.BTF.Platform.CDS.ccllc_agentrole>("ccllc_role_agentrole", null);
			}
			set
			{
				this.OnPropertyChanging("ccllc_role_agentrole");
				this.SetRelatedEntities<CCLLC.BTF.Platform.CDS.ccllc_agentrole>("ccllc_role_agentrole", null, value);
		...
		public CCLLC.BTF.Platform.CDS.BusinessUnit business_unit_ccllc_role
		{
			get
			{
				return this.GetRelatedEntity<CCLLC.BTF.Platform.CDS.BusinessUnit>("business_unit_ccllc_role", null);
			}
		}
		...
		public CCLLC.BTF.Platform.CDS.SystemUser lk_ccllc_role_createdby
		{
			get
			{
				return this.GetRelatedEntity<CCLLC.BTF.Platform.CDS.SystemUser>("lk_ccllc_role_createdby", null);
			}
		}
		...
		public CCLLC.BTF.Platform.CDS.SystemUser lk_ccllc_role_createdonbehalfby
		{
			get
			{
				return this.GetRelatedEntity<CCLLC.BTF.Platform.CDS.SystemUser>("lk_ccllc_role_createdonbehalfby", null);
			}
		}
		...
		public CCLLC.BTF.Platform.CDS.SystemUser lk_ccllc_role_modifiedby
		{
			get
			{
				return this.GetRelatedEntity<CCLLC.BTF.Platform.CDS.SystemUser>("lk_ccllc_role_modifiedby", null);
			}
		}
		...
		public CCLLC.BTF.Platform.CDS.SystemUser lk_ccllc_role_modifiedonbehalfby
		{
			get
			{
				return this.GetRelatedEntity<CCLLC.BTF.Platform.CDS.SystemUser>("lk_ccllc_role_modifiedonbehalfby", null);
			}
		}
		...
		public CCLLC.BTF.Platform.CDS.SystemUser user_ccllc_role
		{
			get
			{
				return this.GetRelatedEntity<CCLLC.BTF.Platform.CDS.SystemUser>("user_ccllc_role", null);
			}
		}
	}
}
