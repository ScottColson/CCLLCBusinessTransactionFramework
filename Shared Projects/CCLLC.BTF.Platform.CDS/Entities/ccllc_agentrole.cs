namespace CCLLC.BTF.Platform.CDS
{
	...
	public partial class ccllc_agentrole : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public System.Nullable<CCLLC.BTF.Platform.CDS.ccllc_agentroleState> statecode
		{
			get
			{
				...
				if ((optionSet != null))
				{
					return ((CCLLC.BTF.Platform.CDS.ccllc_agentroleState)(System.Enum.ToObject(typeof(CCLLC.BTF.Platform.CDS.ccllc_agentroleState), optionSet.Value)));
				}
				else
				{
					return null;
		...
		public System.Nullable<CCLLC.BTF.Platform.CDS.ccllc_agentrole_statuscode> statuscode
		{
			get
			{
				...
				if ((optionSet != null))
				{
					return ((CCLLC.BTF.Platform.CDS.ccllc_agentrole_statuscode)(System.Enum.ToObject(typeof(CCLLC.BTF.Platform.CDS.ccllc_agentrole_statuscode), optionSet.Value)));
				}
				else
				{
					return null;
		...
		public CCLLC.BTF.Platform.CDS.BusinessUnit business_unit_ccllc_agentrole
		{
			get
			{
				return this.GetRelatedEntity<CCLLC.BTF.Platform.CDS.BusinessUnit>("business_unit_ccllc_agentrole", null);
			}
		}
		...
		public CCLLC.BTF.Platform.CDS.SystemUser lk_ccllc_agentrole_createdby
		{
			get
			{
				return this.GetRelatedEntity<CCLLC.BTF.Platform.CDS.SystemUser>("lk_ccllc_agentrole_createdby", null);
			}
		}
		...
		public CCLLC.BTF.Platform.CDS.SystemUser lk_ccllc_agentrole_createdonbehalfby
		{
			get
			{
				return this.GetRelatedEntity<CCLLC.BTF.Platform.CDS.SystemUser>("lk_ccllc_agentrole_createdonbehalfby", null);
			}
		}
		...
		public CCLLC.BTF.Platform.CDS.SystemUser lk_ccllc_agentrole_modifiedby
		{
			get
			{
				return this.GetRelatedEntity<CCLLC.BTF.Platform.CDS.SystemUser>("lk_ccllc_agentrole_modifiedby", null);
			}
		}
		...
		public CCLLC.BTF.Platform.CDS.SystemUser lk_ccllc_agentrole_modifiedonbehalfby
		{
			get
			{
				return this.GetRelatedEntity<CCLLC.BTF.Platform.CDS.SystemUser>("lk_ccllc_agentrole_modifiedonbehalfby", null);
			}
		}
		...
		public CCLLC.BTF.Platform.CDS.ccllc_agent ccllc_agent_agentrole
		{
			get
			{
				return this.GetRelatedEntity<CCLLC.BTF.Platform.CDS.ccllc_agent>("ccllc_agent_agentrole", null);
			}
			set
			{
				this.OnPropertyChanging("ccllc_agent_agentrole");
				this.SetRelatedEntity<CCLLC.BTF.Platform.CDS.ccllc_agent>("ccllc_agent_agentrole", null, value);
		...
		public CCLLC.BTF.Platform.CDS.ccllc_role ccllc_role_agentrole
		{
			get
			{
				return this.GetRelatedEntity<CCLLC.BTF.Platform.CDS.ccllc_role>("ccllc_role_agentrole", null);
			}
			set
			{
				this.OnPropertyChanging("ccllc_role_agentrole");
				this.SetRelatedEntity<CCLLC.BTF.Platform.CDS.ccllc_role>("ccllc_role_agentrole", null, value);
		...
		public CCLLC.BTF.Platform.CDS.SystemUser user_ccllc_agentrole
		{
			get
			{
				return this.GetRelatedEntity<CCLLC.BTF.Platform.CDS.SystemUser>("user_ccllc_agentrole", null);
			}
		}
	}
}
