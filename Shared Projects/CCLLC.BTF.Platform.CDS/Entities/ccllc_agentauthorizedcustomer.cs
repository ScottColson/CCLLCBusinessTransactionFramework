namespace CCLLC.BTF.Platform.CDS
{
	...
	public partial class ccllc_agentauthorizedcustomer : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public System.Nullable<CCLLC.BTF.Platform.CDS.ccllc_agentauthorizedcustomerState> statecode
		{
			get
			{
				...
				if ((optionSet != null))
				{
					return ((CCLLC.BTF.Platform.CDS.ccllc_agentauthorizedcustomerState)(System.Enum.ToObject(typeof(CCLLC.BTF.Platform.CDS.ccllc_agentauthorizedcustomerState), optionSet.Value)));
				}
				else
				{
					return null;
		...
		public System.Nullable<CCLLC.BTF.Platform.CDS.ccllc_agentauthorizedcustomer_statuscode> statuscode
		{
			get
			{
				...
				if ((optionSet != null))
				{
					return ((CCLLC.BTF.Platform.CDS.ccllc_agentauthorizedcustomer_statuscode)(System.Enum.ToObject(typeof(CCLLC.BTF.Platform.CDS.ccllc_agentauthorizedcustomer_statuscode), optionSet.Value)));
				}
				else
				{
					return null;
		...
		public CCLLC.BTF.Platform.CDS.BusinessUnit business_unit_ccllc_agentauthorizedcustomer
		{
			get
			{
				return this.GetRelatedEntity<CCLLC.BTF.Platform.CDS.BusinessUnit>("business_unit_ccllc_agentauthorizedcustomer", null);
			}
		}
		...
		public CCLLC.BTF.Platform.CDS.SystemUser lk_ccllc_agentauthorizedcustomer_createdby
		{
			get
			{
				return this.GetRelatedEntity<CCLLC.BTF.Platform.CDS.SystemUser>("lk_ccllc_agentauthorizedcustomer_createdby", null);
			}
		}
		...
		public CCLLC.BTF.Platform.CDS.SystemUser lk_ccllc_agentauthorizedcustomer_createdonbehalfby
		{
			get
			{
				return this.GetRelatedEntity<CCLLC.BTF.Platform.CDS.SystemUser>("lk_ccllc_agentauthorizedcustomer_createdonbehalfby", null);
			}
		}
		...
		public CCLLC.BTF.Platform.CDS.SystemUser lk_ccllc_agentauthorizedcustomer_modifiedby
		{
			get
			{
				return this.GetRelatedEntity<CCLLC.BTF.Platform.CDS.SystemUser>("lk_ccllc_agentauthorizedcustomer_modifiedby", null);
			}
		}
		...
		public CCLLC.BTF.Platform.CDS.SystemUser lk_ccllc_agentauthorizedcustomer_modifiedonbehalfby
		{
			get
			{
				return this.GetRelatedEntity<CCLLC.BTF.Platform.CDS.SystemUser>("lk_ccllc_agentauthorizedcustomer_modifiedonbehalfby", null);
			}
		}
		...
		public CCLLC.BTF.Platform.CDS.Account ccllc_account_authorizedagent
		{
			get
			{
				return this.GetRelatedEntity<CCLLC.BTF.Platform.CDS.Account>("ccllc_account_authorizedagent", null);
			}
			set
			{
				this.OnPropertyChanging("ccllc_account_authorizedagent");
				this.SetRelatedEntity<CCLLC.BTF.Platform.CDS.Account>("ccllc_account_authorizedagent", null, value);
		...
		public CCLLC.BTF.Platform.CDS.ccllc_agent ccllc_agent_authorizedcustomer
		{
			get
			{
				return this.GetRelatedEntity<CCLLC.BTF.Platform.CDS.ccllc_agent>("ccllc_agent_authorizedcustomer", null);
			}
			set
			{
				this.OnPropertyChanging("ccllc_agent_authorizedcustomer");
				this.SetRelatedEntity<CCLLC.BTF.Platform.CDS.ccllc_agent>("ccllc_agent_authorizedcustomer", null, value);
		...
		public CCLLC.BTF.Platform.CDS.Contact ccllc_contact_authorizedagent
		{
			get
			{
				return this.GetRelatedEntity<CCLLC.BTF.Platform.CDS.Contact>("ccllc_contact_authorizedagent", null);
			}
			set
			{
				this.OnPropertyChanging("ccllc_contact_authorizedagent");
				this.SetRelatedEntity<CCLLC.BTF.Platform.CDS.Contact>("ccllc_contact_authorizedagent", null, value);
		...
		public CCLLC.BTF.Platform.CDS.SystemUser user_ccllc_agentauthorizedcustomer
		{
			get
			{
				return this.GetRelatedEntity<CCLLC.BTF.Platform.CDS.SystemUser>("user_ccllc_agentauthorizedcustomer", null);
			}
		}
	}
}
