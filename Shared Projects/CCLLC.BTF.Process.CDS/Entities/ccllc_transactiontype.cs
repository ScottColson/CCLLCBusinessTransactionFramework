namespace CCLLC.BTF.Process.CDS
{
	...
	public partial class ccllc_transactiontype : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public System.Nullable<CCLLC.BTF.Process.CDS.ccllc_transactiontypeState> statecode
		{
			get
			{
				...
				if ((optionSet != null))
				{
					return ((CCLLC.BTF.Process.CDS.ccllc_transactiontypeState)(System.Enum.ToObject(typeof(CCLLC.BTF.Process.CDS.ccllc_transactiontypeState), optionSet.Value)));
				}
				else
				{
					return null;
		...
		public System.Nullable<CCLLC.BTF.Process.CDS.ccllc_transactiontype_statuscode> statuscode
		{
			get
			{
				...
				if ((optionSet != null))
				{
					return ((CCLLC.BTF.Process.CDS.ccllc_transactiontype_statuscode)(System.Enum.ToObject(typeof(CCLLC.BTF.Process.CDS.ccllc_transactiontype_statuscode), optionSet.Value)));
				}
				else
				{
					return null;
		...
		public System.Collections.Generic.IEnumerable<CCLLC.BTF.Process.CDS.ccllc_transactiontypeauthorizedchannel> ccllc_transactiontype_authorizedchannel
		{
			get
			{
				return this.GetRelatedEntities<CCLLC.BTF.Process.CDS.ccllc_transactiontypeauthorizedchannel>("ccllc_transactiontype_authorizedchannel", null);
			}
			set
			{
				this.OnPropertyChanging("ccllc_transactiontype_authorizedchannel");
				this.SetRelatedEntities<CCLLC.BTF.Process.CDS.ccllc_transactiontypeauthorizedchannel>("ccllc_transactiontype_authorizedchannel", null, value);
		...
		public System.Collections.Generic.IEnumerable<CCLLC.BTF.Process.CDS.ccllc_transactiontypeauthorizedrole> ccllc_transactiontype_authorizedroles
		{
			get
			{
				return this.GetRelatedEntities<CCLLC.BTF.Process.CDS.ccllc_transactiontypeauthorizedrole>("ccllc_transactiontype_authorizedroles", null);
			}
			set
			{
				this.OnPropertyChanging("ccllc_transactiontype_authorizedroles");
				this.SetRelatedEntities<CCLLC.BTF.Process.CDS.ccllc_transactiontypeauthorizedrole>("ccllc_transactiontype_authorizedroles", null, value);
		...
		public System.Collections.Generic.IEnumerable<CCLLC.BTF.Process.CDS.ccllc_transactionprocess> ccllc_transactiontype_availableprocesses
		{
			get
			{
				return this.GetRelatedEntities<CCLLC.BTF.Process.CDS.ccllc_transactionprocess>("ccllc_transactiontype_availableprocesses", null);
			}
			set
			{
				this.OnPropertyChanging("ccllc_transactiontype_availableprocesses");
				this.SetRelatedEntities<CCLLC.BTF.Process.CDS.ccllc_transactionprocess>("ccllc_transactiontype_availableprocesses", null, value);
		...
		public System.Collections.Generic.IEnumerable<CCLLC.BTF.Process.CDS.ccllc_transactiontypecontext> ccllc_transactiontype_context
		{
			get
			{
				return this.GetRelatedEntities<CCLLC.BTF.Process.CDS.ccllc_transactiontypecontext>("ccllc_transactiontype_context", null);
			}
			set
			{
				this.OnPropertyChanging("ccllc_transactiontype_context");
				this.SetRelatedEntities<CCLLC.BTF.Process.CDS.ccllc_transactiontypecontext>("ccllc_transactiontype_context", null, value);
		...
		public System.Collections.Generic.IEnumerable<CCLLC.BTF.Process.CDS.ccllc_transactioninitialfee> ccllc_transactiontype_initialfee
		{
			get
			{
				return this.GetRelatedEntities<CCLLC.BTF.Process.CDS.ccllc_transactioninitialfee>("ccllc_transactiontype_initialfee", null);
			}
			set
			{
				this.OnPropertyChanging("ccllc_transactiontype_initialfee");
				this.SetRelatedEntities<CCLLC.BTF.Process.CDS.ccllc_transactioninitialfee>("ccllc_transactiontype_initialfee", null, value);
		...
		public System.Collections.Generic.IEnumerable<CCLLC.BTF.Process.CDS.ccllc_transaction> ccllc_transactiontype_relatedtransaction
		{
			get
			{
				return this.GetRelatedEntities<CCLLC.BTF.Process.CDS.ccllc_transaction>("ccllc_transactiontype_relatedtransaction", null);
			}
			set
			{
		...
		public CCLLC.BTF.Process.CDS.ccllc_transactiongroup ccllc_transactiontype_parentgroup
		{
			get
			{
				return this.GetRelatedEntity<CCLLC.BTF.Process.CDS.ccllc_transactiongroup>("ccllc_transactiontype_parentgroup", null);
			}
			set
			{
				this.OnPropertyChanging("ccllc_transactiontype_parentgroup");
				this.SetRelatedEntity<CCLLC.BTF.Process.CDS.ccllc_transactiongroup>("ccllc_transactiontype_parentgroup", null, value);
		...
		public CCLLC.BTF.Process.CDS.ccllc_transactionprocess ccllc_transactiontype_startupprocess
		{
			get
			{
				return this.GetRelatedEntity<CCLLC.BTF.Process.CDS.ccllc_transactionprocess>("ccllc_transactiontype_startupprocess", null);
			}
			set
			{
				this.OnPropertyChanging("ccllc_transactiontype_startupprocess");
				this.SetRelatedEntity<CCLLC.BTF.Process.CDS.ccllc_transactionprocess>("ccllc_transactiontype_startupprocess", null, value);
