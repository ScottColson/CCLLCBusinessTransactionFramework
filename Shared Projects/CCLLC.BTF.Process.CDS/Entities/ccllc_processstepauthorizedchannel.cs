namespace CCLLC.BTF.Process.CDS
{
	...
	public partial class ccllc_processstepauthorizedchannel : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public System.Nullable<CCLLC.BTF.Process.CDS.ccllc_processstepauthorizedchannelState> statecode
		{
			get
			{
				...
				if ((optionSet != null))
				{
					return ((CCLLC.BTF.Process.CDS.ccllc_processstepauthorizedchannelState)(System.Enum.ToObject(typeof(CCLLC.BTF.Process.CDS.ccllc_processstepauthorizedchannelState), optionSet.Value)));
				}
				else
				{
					return null;
		...
		public System.Nullable<CCLLC.BTF.Process.CDS.ccllc_processstepauthorizedchannel_statuscode> statuscode
		{
			get
			{
				...
				if ((optionSet != null))
				{
					return ((CCLLC.BTF.Process.CDS.ccllc_processstepauthorizedchannel_statuscode)(System.Enum.ToObject(typeof(CCLLC.BTF.Process.CDS.ccllc_processstepauthorizedchannel_statuscode), optionSet.Value)));
				}
				else
				{
					return null;
		...
		public CCLLC.BTF.Process.CDS.ccllc_processstep ccllc_step_ccllc_stepauthorizedchannel
		{
			get
			{
				return this.GetRelatedEntity<CCLLC.BTF.Process.CDS.ccllc_processstep>("ccllc_step_ccllc_stepauthorizedchannel", null);
			}
			set
			{
				this.OnPropertyChanging("ccllc_step_ccllc_stepauthorizedchannel");
				this.SetRelatedEntity<CCLLC.BTF.Process.CDS.ccllc_processstep>("ccllc_step_ccllc_stepauthorizedchannel", null, value);
