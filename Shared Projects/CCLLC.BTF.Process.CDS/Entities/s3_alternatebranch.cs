namespace CCLLC.BTF.Process.CDS
{
	...
	public partial class ccllc_alternatebranch : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public System.Nullable<CCLLC.BTF.Process.CDS.ccllc_alternatebranchState> statecode
		{
			get
			{
				...
				if ((optionSet != null))
				{
					return ((CCLLC.BTF.Process.CDS.ccllc_alternatebranchState)(System.Enum.ToObject(typeof(CCLLC.BTF.Process.CDS.ccllc_alternatebranchState), optionSet.Value)));
				}
				else
				{
					return null;
		...
		public System.Nullable<CCLLC.BTF.Process.CDS.ccllc_alternatebranch_statuscode> statuscode
		{
			get
			{
				...
				if ((optionSet != null))
				{
					return ((CCLLC.BTF.Process.CDS.ccllc_alternatebranch_statuscode)(System.Enum.ToObject(typeof(CCLLC.BTF.Process.CDS.ccllc_alternatebranch_statuscode), optionSet.Value)));
				}
				else
				{
					return null;
		...
		public CCLLC.BTF.Process.CDS.ccllc_processstep ccllc_parentprocessstep_alternatebranch
		{
			get
			{
				return this.GetRelatedEntity<CCLLC.BTF.Process.CDS.ccllc_processstep>("ccllc_parentprocessstep_alternatebranch", null);
			}
			set
			{
				this.OnPropertyChanging("ccllc_parentprocessstep_alternatebranch");
				this.SetRelatedEntity<CCLLC.BTF.Process.CDS.ccllc_processstep>("ccllc_parentprocessstep_alternatebranch", null, value);
		...
		public CCLLC.BTF.Process.CDS.ccllc_processstep ccllc_subsequentprocessstep_alternatebranch
		{
			get
			{
				return this.GetRelatedEntity<CCLLC.BTF.Process.CDS.ccllc_processstep>("ccllc_subsequentprocessstep_alternatebranch", null);
			}
			set
			{
				this.OnPropertyChanging("ccllc_subsequentprocessstep_alternatebranch");
				this.SetRelatedEntity<CCLLC.BTF.Process.CDS.ccllc_processstep>("ccllc_subsequentprocessstep_alternatebranch", null, value);
