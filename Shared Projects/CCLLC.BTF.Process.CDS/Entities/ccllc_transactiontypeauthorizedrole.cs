namespace CCLLC.BTF.Process.CDS
{
	...
	public partial class ccllc_transactiontypeauthorizedrole : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public System.Nullable<CCLLC.BTF.Process.CDS.ccllc_transactiontypeauthorizedroleState> statecode
		{
			get
			{
				...
				if ((optionSet != null))
				{
					return ((CCLLC.BTF.Process.CDS.ccllc_transactiontypeauthorizedroleState)(System.Enum.ToObject(typeof(CCLLC.BTF.Process.CDS.ccllc_transactiontypeauthorizedroleState), optionSet.Value)));
				}
				else
				{
					return null;
		...
		public System.Nullable<CCLLC.BTF.Process.CDS.ccllc_transactiontypeauthorizedrole_statuscode> statuscode
		{
			get
			{
				...
				if ((optionSet != null))
				{
					return ((CCLLC.BTF.Process.CDS.ccllc_transactiontypeauthorizedrole_statuscode)(System.Enum.ToObject(typeof(CCLLC.BTF.Process.CDS.ccllc_transactiontypeauthorizedrole_statuscode), optionSet.Value)));
				}
				else
				{
					return null;
		...
		public CCLLC.BTF.Process.CDS.ccllc_transactiontype ccllc_transactiontype_authorizedroles
		{
			get
			{
				return this.GetRelatedEntity<CCLLC.BTF.Process.CDS.ccllc_transactiontype>("ccllc_transactiontype_authorizedroles", null);
			}
			set
			{
				this.OnPropertyChanging("ccllc_transactiontype_authorizedroles");
				this.SetRelatedEntity<CCLLC.BTF.Process.CDS.ccllc_transactiontype>("ccllc_transactiontype_authorizedroles", null, value);
