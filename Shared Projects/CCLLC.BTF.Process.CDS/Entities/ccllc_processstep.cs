namespace CCLLC.BTF.Process.CDS
{
	...
	public partial class ccllc_processstep : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public System.Nullable<CCLLC.BTF.Process.CDS.ccllc_processstepState> statecode
		{
			get
			{
				...
				if ((optionSet != null))
				{
					return ((CCLLC.BTF.Process.CDS.ccllc_processstepState)(System.Enum.ToObject(typeof(CCLLC.BTF.Process.CDS.ccllc_processstepState), optionSet.Value)));
				}
				else
				{
					return null;
		...
		public System.Nullable<CCLLC.BTF.Process.CDS.ccllc_processstep_statuscode> statuscode
		{
			get
			{
				...
				if ((optionSet != null))
				{
					return ((CCLLC.BTF.Process.CDS.ccllc_processstep_statuscode)(System.Enum.ToObject(typeof(CCLLC.BTF.Process.CDS.ccllc_processstep_statuscode), optionSet.Value)));
				}
				else
				{
					return null;
		...
		public System.Collections.Generic.IEnumerable<CCLLC.BTF.Process.CDS.ccllc_alternatebranch> ccllc_parentprocessstep_alternatebranch
		{
			get
			{
				return this.GetRelatedEntities<CCLLC.BTF.Process.CDS.ccllc_alternatebranch>("ccllc_parentprocessstep_alternatebranch", null);
			}
			set
			{
				this.OnPropertyChanging("ccllc_parentprocessstep_alternatebranch");
				this.SetRelatedEntities<CCLLC.BTF.Process.CDS.ccllc_alternatebranch>("ccllc_parentprocessstep_alternatebranch", null, value);
		...
		public System.Collections.Generic.IEnumerable<CCLLC.BTF.Process.CDS.ccllc_stephistory> ccllc_processstep_stephistory
		{
			get
			{
				return this.GetRelatedEntities<CCLLC.BTF.Process.CDS.ccllc_stephistory>("ccllc_processstep_stephistory", null);
			}
			set
			{
				this.OnPropertyChanging("ccllc_processstep_stephistory");
				this.SetRelatedEntities<CCLLC.BTF.Process.CDS.ccllc_stephistory>("ccllc_processstep_stephistory", null, value);
		...
		public System.Collections.Generic.IEnumerable<CCLLC.BTF.Process.CDS.ccllc_processsteprequirement> ccllc_processstep_steprequirement
		{
			get
			{
				return this.GetRelatedEntities<CCLLC.BTF.Process.CDS.ccllc_processsteprequirement>("ccllc_processstep_steprequirement", null);
			}
			set
			{
				this.OnPropertyChanging("ccllc_processstep_steprequirement");
				this.SetRelatedEntities<CCLLC.BTF.Process.CDS.ccllc_processsteprequirement>("ccllc_processstep_steprequirement", null, value);
		...
		public System.Collections.Generic.IEnumerable<CCLLC.BTF.Process.CDS.ccllc_processstep> Referencedccllc_processstep_subsequentstep
		{
			get
			{
				return this.GetRelatedEntities<CCLLC.BTF.Process.CDS.ccllc_processstep>("ccllc_processstep_subsequentstep", Microsoft.Xrm.Sdk.EntityRole.Referenced);
			}
			set
			{
				this.OnPropertyChanging("Referencedccllc_processstep_subsequentstep");
				this.SetRelatedEntities<CCLLC.BTF.Process.CDS.ccllc_processstep>("ccllc_processstep_subsequentstep", Microsoft.Xrm.Sdk.EntityRole.Referenced, value);
		...
		public System.Collections.Generic.IEnumerable<CCLLC.BTF.Process.CDS.ccllc_processstepauthorizedchannel> ccllc_step_ccllc_stepauthorizedchannel
		{
			get
			{
				return this.GetRelatedEntities<CCLLC.BTF.Process.CDS.ccllc_processstepauthorizedchannel>("ccllc_step_ccllc_stepauthorizedchannel", null);
			}
			set
			{
				this.OnPropertyChanging("ccllc_step_ccllc_stepauthorizedchannel");
				this.SetRelatedEntities<CCLLC.BTF.Process.CDS.ccllc_processstepauthorizedchannel>("ccllc_step_ccllc_stepauthorizedchannel", null, value);
		...
		public System.Collections.Generic.IEnumerable<CCLLC.BTF.Process.CDS.ccllc_alternatebranch> ccllc_subsequentprocessstep_alternatebranch
		{
			get
			{
				return this.GetRelatedEntities<CCLLC.BTF.Process.CDS.ccllc_alternatebranch>("ccllc_subsequentprocessstep_alternatebranch", null);
			}
			set
			{
				this.OnPropertyChanging("ccllc_subsequentprocessstep_alternatebranch");
				this.SetRelatedEntities<CCLLC.BTF.Process.CDS.ccllc_alternatebranch>("ccllc_subsequentprocessstep_alternatebranch", null, value);
		...
		public System.Collections.Generic.IEnumerable<CCLLC.BTF.Process.CDS.ccllc_transaction> ccllc_transaction_currentprocessstep
		{
			get
			{
				return this.GetRelatedEntities<CCLLC.BTF.Process.CDS.ccllc_transaction>("ccllc_transaction_currentprocessstep", null);
			}
			set
			{
				this.OnPropertyChanging("ccllc_transaction_currentprocessstep");
				this.SetRelatedEntities<CCLLC.BTF.Process.CDS.ccllc_transaction>("ccllc_transaction_currentprocessstep", null, value);
		...
		public System.Collections.Generic.IEnumerable<CCLLC.BTF.Process.CDS.ccllc_transactionprocess> ccllc_transactionprocess_initialstep
		{
			get
			{
				return this.GetRelatedEntities<CCLLC.BTF.Process.CDS.ccllc_transactionprocess>("ccllc_transactionprocess_initialstep", null);
			}
			set
			{
				this.OnPropertyChanging("ccllc_transactionprocess_initialstep");
				this.SetRelatedEntities<CCLLC.BTF.Process.CDS.ccllc_transactionprocess>("ccllc_transactionprocess_initialstep", null, value);
		...
		public CCLLC.BTF.Process.CDS.ccllc_processsteptype ccllc_processstep_steptype
		{
			get
			{
				return this.GetRelatedEntity<CCLLC.BTF.Process.CDS.ccllc_processsteptype>("ccllc_processstep_steptype", null);
			}
			set
			{
				this.OnPropertyChanging("ccllc_processstep_steptype");
				this.SetRelatedEntity<CCLLC.BTF.Process.CDS.ccllc_processsteptype>("ccllc_processstep_steptype", null, value);
		...
		public CCLLC.BTF.Process.CDS.ccllc_processstep Referencingccllc_processstep_subsequentstep
		{
			get
			{
				return this.GetRelatedEntity<CCLLC.BTF.Process.CDS.ccllc_processstep>("ccllc_processstep_subsequentstep", Microsoft.Xrm.Sdk.EntityRole.Referencing);
			}
			set
			{
				this.OnPropertyChanging("Referencingccllc_processstep_subsequentstep");
				this.SetRelatedEntity<CCLLC.BTF.Process.CDS.ccllc_processstep>("ccllc_processstep_subsequentstep", Microsoft.Xrm.Sdk.EntityRole.Referencing, value);
		...
		public CCLLC.BTF.Process.CDS.ccllc_transactionprocess ccllc_transactionprocess_assignedsteps
		{
			get
			{
				return this.GetRelatedEntity<CCLLC.BTF.Process.CDS.ccllc_transactionprocess>("ccllc_transactionprocess_assignedsteps", null);
			}
			set
			{
				this.OnPropertyChanging("ccllc_transactionprocess_assignedsteps");
				this.SetRelatedEntity<CCLLC.BTF.Process.CDS.ccllc_transactionprocess>("ccllc_transactionprocess_assignedsteps", null, value);
