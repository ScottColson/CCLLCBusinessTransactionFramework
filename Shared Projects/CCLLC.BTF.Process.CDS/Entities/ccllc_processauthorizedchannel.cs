namespace CCLLC.BTF.Process.CDS
{
	...
	public partial class ccllc_processauthorizedchannel : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public System.Nullable<CCLLC.BTF.Process.CDS.ccllc_processauthorizedchannelState> statecode
		{
			get
			{
				...
				if ((optionSet != null))
				{
					return ((CCLLC.BTF.Process.CDS.ccllc_processauthorizedchannelState)(System.Enum.ToObject(typeof(CCLLC.BTF.Process.CDS.ccllc_processauthorizedchannelState), optionSet.Value)));
				}
				else
				{
					return null;
		...
		public System.Nullable<CCLLC.BTF.Process.CDS.ccllc_processauthorizedchannel_statuscode> statuscode
		{
			get
			{
				...
				if ((optionSet != null))
				{
					return ((CCLLC.BTF.Process.CDS.ccllc_processauthorizedchannel_statuscode)(System.Enum.ToObject(typeof(CCLLC.BTF.Process.CDS.ccllc_processauthorizedchannel_statuscode), optionSet.Value)));
				}
				else
				{
					return null;
		...
		public CCLLC.BTF.Process.CDS.ccllc_transactionprocess ccllc_process_ccllc_processauthorizedchannel
		{
			get
			{
				return this.GetRelatedEntity<CCLLC.BTF.Process.CDS.ccllc_transactionprocess>("ccllc_process_ccllc_processauthorizedchannel", null);
			}
			set
			{
				this.OnPropertyChanging("ccllc_process_ccllc_processauthorizedchannel");
				this.SetRelatedEntity<CCLLC.BTF.Process.CDS.ccllc_transactionprocess>("ccllc_process_ccllc_processauthorizedchannel", null, value);
