namespace CCLLC.BTF.Process.CDS
{
	...
	public partial class ccllc_transactiontypeauthorizedchannel : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public System.Nullable<CCLLC.BTF.Process.CDS.ccllc_transactiontypeauthorizedchannelState> statecode
		{
			get
			{
				...
				if ((optionSet != null))
				{
					return ((CCLLC.BTF.Process.CDS.ccllc_transactiontypeauthorizedchannelState)(System.Enum.ToObject(typeof(CCLLC.BTF.Process.CDS.ccllc_transactiontypeauthorizedchannelState), optionSet.Value)));
				}
				else
				{
					return null;
		...
		public System.Nullable<CCLLC.BTF.Process.CDS.ccllc_transactiontypeauthorizedchannel_statuscode> statuscode
		{
			get
			{
				...
				if ((optionSet != null))
				{
					return ((CCLLC.BTF.Process.CDS.ccllc_transactiontypeauthorizedchannel_statuscode)(System.Enum.ToObject(typeof(CCLLC.BTF.Process.CDS.ccllc_transactiontypeauthorizedchannel_statuscode), optionSet.Value)));
				}
				else
				{
					return null;
		...
		public CCLLC.BTF.Process.CDS.ccllc_transactiontype ccllc_transactiontype_authorizedchannel
		{
			get
			{
				return this.GetRelatedEntity<CCLLC.BTF.Process.CDS.ccllc_transactiontype>("ccllc_transactiontype_authorizedchannel", null);
			}
			set
			{
				this.OnPropertyChanging("ccllc_transactiontype_authorizedchannel");
				this.SetRelatedEntity<CCLLC.BTF.Process.CDS.ccllc_transactiontype>("ccllc_transactiontype_authorizedchannel", null, value);
