...
namespace CCLLC.BTF.Process
{
    ...
    public class TransactionDeficiencyFactory : ITransactionDeficienciesFactory
    {
        
        private ITransactionDataConnector DataConnector { get; }
        private IAgentFactory AgentFactory { get; }

        public TransactionDeficiencyFactory(ITransactionDataConnector dataConnector, IAgentFactory agentFactory)
        {
